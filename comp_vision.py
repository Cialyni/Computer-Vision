...
class ComputerVisionProcessor:
    ...
    def rotate_30_degrees_around_point(self, point):
        ...
        self.save_image(
            rotated, "09_rotated_30_point.jpg", f"Rotated 30° around {point}"
        )
        return rotated
    ...
    def adjust_contrast(self):
        ...
        self.save_image(
            high_contrast, "12_high_contrast.jpg", f"High Contrast (α={alpha})"
        )
    ...
    def gamma_correction(self):
        ...
        self.save_image(
            gamma_corrected, "13_gamma_corrected.jpg", f"Gamma Correction (γ={gamma})"
        )
    ...
    def histogram_equalization(self):
        ...
        self.save_image(
            equalized, "14_color_equalized.jpg", "Color Histogram Equalization"
        )
    ...
    def find_contours_binary(self):
        ...
        self.save_image(
            contours_image,
            "19_contours_on_image.jpg",
            f"Contours ({len(contours)} found)",
        )
    ...
    def find_contours_with_filters(self):
        ...
        self.save_image(
            sobel_contours,
            "20_sobel_contours.jpg",
            f"Sobel Contours ({len(contours_sobel)})",
        )
        self.save_image(
            laplacian_contours,
            "20_laplacian_contours.jpg",
            f"Laplacian Contours ({len(contours_laplacian)})",
        )
    ...
    def run_all_operations(self, rotation_point=(100, 100)):
        ...
        operations = [
            ...
            (
                "Rotate 30° around point",
                lambda: self.rotate_30_degrees_around_point(rotation_point),
            ),
...
def main():
    image_path = input(
        "Введите путь к изображению (или нажмите Enter для тестового): "
    ).strip()
